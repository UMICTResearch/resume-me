...
# View seen when looking for received feedback
#
@feedback.route('/feedback/seeker')
@login_required
def feedback_seeker():
...
# View seen when giving feedback to someone else
#
@feedback.route('/feedback/volunteer')
@login_required
def feedback_volunteer():

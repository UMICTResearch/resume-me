...
@notes_app.route('/notes')
def notes():
    templateData = {
        'notes': models.Note.objects.order_by("-last_updated")
    }
    return render_template('notes/index.html', **templateData)
...
def admin_entry_create():
    if request.method == "POST":
        ...
        return render_template('notes/edit.html', **template_data)
...
def entry_page(note_id):
    ...
    if note:
        ...
        return render_template('notes/view.html', **templateData)
